      ...
      <div className="container mx-auto px-4 z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 glass rounded-full text-accent text-sm font-semibold mb-6">
            ...
            <span>Global Logistics Expert</span>
          </div>
          <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-6">
            <span className="text-white">szexpress.org</span>
            <br />
            <span className="text-accent italic">Global Special Line</span>
          </h1>
          <p className="text-xl text-gray-300 mb-10 max-w-lg">
            ...
            Air and sea freight directly to your doorstep.
          </p>
